...
function initMobileBackground() {
    ...
    function resetAnimation() {
        stopBgAnimation(); // Para a animação atual
        if (isMobile()) {
            toggleBackground(); // Alterna imediatamente para a próxima imagem
            startBgAnimation(); // Reinicia a animação
        }
    }

    window.addEventListener('resize', resetAnimation); // Reinicia animação ao redimensionar
